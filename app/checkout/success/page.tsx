    ...
    <div className="flex items-center justify-center min-h-screen bg-[#fcfdfd] font-sans selection:bg-[#15b375]/10">
      ...
      <div className="relative z-10 bg-white border border-gray-100 rounded-[3rem] shadow-[0_48px_100px_-24px_rgba(21,179,117,0.15)] p-10 md:p-14 max-w-xl w-full mx-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          {/* Order ID Card */}
          <div className="bg-[#fcfdfd] border border-gray-100 rounded-[2rem] p-6 text-center relative overflow-hidden group hover:border-[#15b375]/30 transition-colors">
          ...
          <div className="bg-[#fcfdfd] border border-gray-100 rounded-[2rem] p-6 text-center relative overflow-hidden group hover:border-[#15b375]/30 transition-colors">
            <div className="absolute top-0 right-0 p-2 opacity-5">
              <svg className="w-12 h-12 text-[#15b375]" fill="currentColor" viewBox="0 0 24 24"><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm13.5 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" /></svg>
            </div>
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 block mb-2">Estimated Delivery</span>
        ...
        <div className="border-t border-gray-100 pt-8 mb-10">
          <h3 className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-6 text-center">What happens next?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { title: 'Processing', desc: 'Sourcing your items sustainably.', icon: '🌱' },
              { title: 'Carbon Offset', desc: '1 tree planted for this order.', icon: '🌳' },
              { title: 'Delivery', desc: 'Shipped in plastic-free packaging.', icon: '📦' }
            ].map((step, i) => (
