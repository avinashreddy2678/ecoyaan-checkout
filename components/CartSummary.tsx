...
export const CartSummary = ({ cart, onProceed, isActive = true }: Props) => {
    ...
    <div className="flex flex-col bg-white border border-gray-100 rounded-2xl p-7 shadow-sm">
        ...
        {cart.cartItems.map((item) => (
          <div key={item.product_id} className="flex justify-between">
            ...
            <div className="flex gap-4">
              ...
              <div className="relative w-16 h-16 bg-[#f0f9f1] rounded-xl">
      ...
      <div className="space-y-3 border-t pt-6">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="text-[#15b375] font-bold">FREE</span>
        </div>
      ...
      {isActive && (
        <button
          onClick={onProceed}
          className="mt-8 w-full bg-[#15b375] text-white font-bold py-4 rounded-xl hover:bg-[#108a5a]"
        >
